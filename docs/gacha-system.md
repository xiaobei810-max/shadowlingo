...
const GACHA_SERIES = {
  'nora-debut': {
    ...
    items: [
      // ── N (50%) ───────────────────────────
      { id: 'nd_n_card_tam',   tier: 'N',  type: 'card',
        nameZh: '天安门明信片', nameEn: 'Tiananmen Postcard',
        img: '/assets/gacha/nora-debut/card_tam.png',
        flavor: '诺拉路过时拍的第一张照片。' },
...
// localStorage key: 'echo_gacha_state_v1'
{
  version: 1,
  collection: {
    'nd_n_card_tam':   { count: 3, firstAt: 1761820000000 },
...
│     ├─ diary_01.png             # R 日记封面
│     ├─ diary_02.png             # R 日记封面
│     ├─ diary_sr.png             # SR 日记封面
│     ├─ diary_sr.mp3             # SR 日记语音
